...
clean_lang_js = """const translations = {
    "tr": {
...
with io.open(lang_path, 'w', encoding='utf-8') as f:
    f.write(clean_lang_js)

# Also force index.html cache bust again
html_path = 'index.html'
with io.open(html_path, 'r', encoding='utf-8') as f:
    html = f.read()
html = html.replace('assets/lang.js?v=11', 'assets/lang.js?v=12')
with io.open(html_path, 'w', encoding='utf-8') as f:
    f.write(html)

print("lang.js completely rebuilt cleanly.")
